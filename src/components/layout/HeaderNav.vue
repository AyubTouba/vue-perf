<template>
    <header class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full text-sm">
        <nav class="relative max-w-[85rem] w-full mx-auto bg-white border-b border-gray-200 py-3 px-4 sm:py-0 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:border-x dark:bg-gray-800 dark:border-gray-700"
            aria-label="Global">
            <div class="flex items-center justify-between">
                <RouterLink class="flex-none text-xl font-semibold dark:text-white" to="/" aria-label="Brand">Perf
                </RouterLink>
                <div class="sm:hidden">
                    <button type="button"
            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <RouterLink
                        ...
                        to="/" aria-current="page">Home</RouterLink>
                    <RouterLink
                    ...
                    <RouterLink
                        class="font-medium text-gray-500 hover:text-gray-400 sm:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                        to="/tablevue">Table Test 1</RouterLink>
